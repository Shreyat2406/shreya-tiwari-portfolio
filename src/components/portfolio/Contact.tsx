...
const items = [
  ...
  { Icon: Linkedin, label: "LinkedIn", value: "linkedin.com/in/shreya-tiwari-1ab046301", href: "https://linkedin.com/in/shreya-tiwari-1ab046301" },
...
export function Contact() {
  return (
    <section id="contact" className="relative px-5 sm:px-6 py-14 sm:py-20 max-w-6xl mx-auto">
      <div className="glass-strong rounded-[2rem] sm:rounded-[2.5rem] p-7 sm:p-12 lg:p-16 text-center relative overflow-hidden">
        ...
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-gradient max-w-3xl mx-auto">
        ...
        <a href="mailto:shreya.t2406@gmail.com"
          className="cta-solid mt-7 inline-flex items-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 rounded-full text-sm font-medium transition-opacity">
          <Mail className="w-4 h-4" /> Say Hello
        </a>

        <div className="mt-9 grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-left">
